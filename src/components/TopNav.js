    ...
    <div className="max-w-[1520] mx-auto flex justify-between items-center p-4">
      <div className="flex items-center">
        ...
        <h1 className="text-2xl sm:text-3xl lg:text-4xl px-2">
          Naija<span className="font-bold">Eats</span>
        </h1>
      ...
      <div className="bg-green-200 rounded-full flex items-center px-2 w-[200px] sm:w0[400px] lg:w-[500px]">
      ...
      >
        ...
        <h2 className="text-2xl p-4">
          Naija<span className="text-green-700 font-bold">Eats</span>
          <nav>
